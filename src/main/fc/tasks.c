...
task_attribute_t task_attributes[TASK_COUNT] = {
    ...
    [TASK_SERIAL] = DEFINE_TASK("SERIAL", NULL, NULL, taskHandleSerial, TASK_PERIOD_HZ(1000), TASK_PRIORITY_LOW), // Process MSP commands at up to 1 kHz; UART bandwidth must support the configured packet rate.
